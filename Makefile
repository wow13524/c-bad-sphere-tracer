...
HEAD	= scene.h render_output.h camera.h vector3.h color3.h ray.h ray_march_result.h instance.h sdf_instance.h light.h
OBJ     = main.o scene.o camera.o render_output.o vector3.o color3.o ray.o ray_march_result.o instance.o sdf_instance.o light.o
